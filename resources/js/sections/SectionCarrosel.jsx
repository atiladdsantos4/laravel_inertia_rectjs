...
export const SectionCarrosel = (props)=> {
  ...
  const { carroselstore, count } = useStore();
      ...
      if( carroselstore == 0 ){
            ...
            dados.map((item,index)=>{
                ...
                case "listaimgsection":
                    ...
                    let lista = string.meta.filter((it)=>it.naoexibir === false )
                    setListaImg(lista)
                    break
                }
           })
         ...
         axios
            .get(`${endpoint}/section/4?section_man=S`, {
                headers: {
  ...
  return (
    <>
      {/* <span>{'mudei: '+ carroselstore}</span> */}
      {/* <span>{'mudeiRam: '+ countstore}</span> */}
      <Swiper
        pagination={{
          type: 'progressbar',
        }}
