...
export const ModalPesquisaServico = (props) => {
  const {open,close,listatra,item,edita} = props
  ...
  const ItensAcao = (props) => {
     return(
      <>
         <FontAwesomeIcon onClick={(e)=>EditaService(item, props.dados)} style={{color:'blue',cursor:'pointer'}} icon={faRightToBracket}/>
      </>
     )
  }
